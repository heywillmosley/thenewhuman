...
FLCustomizer::add_panel('fl-header', array(
	...
	'sections' => array(
		...
		'fl-topbar-bg' => array(
			'title'     => _x( 'Top Bar Background', 'Customizer section title.', 'fl-automator' ),
			'options'   => array(
		...
		'fl-header-bg' => array(
			'title'   => _x( 'Header Background', 'Customizer section title.', 'fl-automator' ),
			'options' => array(
		...
		'fl-nav-bg' => array(
			'title'   => _x( 'Navigation Background', 'Customizer section title.', 'fl-automator' ),
			'options' => array(
		...
		/* Nav Font Section */
		'fl-nav-font' => array(
			'title'   => _x( 'Navigation Text', 'Customizer section title.', 'fl-automator' ),
			'options' => array(
				...
				'fl-nav-text-type' => array(
					...
					'control'   => array(
						...
						'type'          => 'select',
						'choices'       => array(
							'default' => _x( 'Default', 'Navigation text type.', 'fl-automator' ),
							'custom'  => _x( 'Custom', 'Navigation text type.', 'fl-automator' )
						)
					)
				),
