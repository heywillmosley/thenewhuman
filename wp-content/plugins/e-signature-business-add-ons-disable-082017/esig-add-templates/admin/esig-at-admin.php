       ...
       <div class="inside">';
        ...
        public function sifinputfield() {
            ...
            foreach ($this->temp_short as $temp => $value) {
                ...
                $html .= '<div id="signer_main_pop" class="container-fluid"><div id="signer_main_temp" class="row leftPadding-30 topPadding bottomPadding">
				...
				<input type="text" class="form-control esig-input"  name="recipient_fnames[]" placeholder="Signers Name" value="' . $first_name . '" /></div>
					<div class="col-sm-5 noPadding leftPadding-5"><input type="text" class="form-control esig-input" name="recipient_emails[]" placeholder="email@address.com" value="' . $user_email . '" /></div><div class="col-md-2 noPadding text-left"><span id="second_layer_verification" class="icon-doorkey second-layer"></span><span id="esig-del-signer" class="deleteIcon"></span></div></div>
							 ';
