...
class WooCommerce_Print_Products {
	...
	private function load_dependencies() {
	    ...
	    // Load MPDF library
	    if ( file_exists( plugin_dir_path( dirname( __FILE__ ) ) . 'includes/mpdf/mpdf.php' ) && !class_exists('mPDF') ) {
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'init', $this->plugin_public, 'initWooCommerce_Print_Products' );
	}
