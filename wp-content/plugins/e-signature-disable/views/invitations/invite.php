                ...
                <tbody>
                  <tr style="border-collapse:collapse">
                    <td style="padding: 16px 12px 0px 20px;vertical-align: top;font-family: 'Helvetica Neue',Arial,Helvetica,sans-serif;font-size: 12px;line-height: 1.5em;border-collapse: collapse;color: #555;"
                      align="left"><?php echo sprintf( __( 'This message was sent to you by %s who is using the <a href="http://wpesign.com/?utm_source=wpesignplugin&utm_medium=signer-invite-email&utm_campaign=header-logo" style="text-decoration:none;color:#555;">WP E-Signature Document Signing WordPress plugin</a>. If you would rather not receive email from this sender you may contact the sender with your request.', 'esig'), $data['user_full_name'] );?> </td>
...
Neue',Arial,Helvetica,sans-serif;font-size:12px;line-height:1.4em;border-collapse:collapse;color:#555"
                    ...
                    <td style="padding:0px 0px 0px
                      0px;vertical-align:top;font-family:'Helvetica
Neue',Arial,Helvetica,sans-serif;font-size:12px;line-height:1.4em;border-collapse:collapse;color:#555"
                      align="center"> <a href="http://wpesign.com/?utm_source=wpesignplugin&utm_medium=signer-invite-email&utm_campaign=learn-more" target="_blank"><img class="esig-verified-email"
