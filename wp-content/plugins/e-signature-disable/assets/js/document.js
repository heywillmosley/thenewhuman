    ...
    $('#submit_signer_save').click(function () {
        ...
        jQuery.ajax({
            ...
            success: function (data, status, jqXHR) {
                ...
                location.reload();
                //window.location.href = "edit.php?post_type=esign&page=esign-add-document&esig_type=basic&document_id="+ esig_document_id.val() +"&add_tmp=1&temp_id="+ temp_id;

                //window.location.href = "edit.php?post_type=esign&page=esign-add-document&document_id="+ esig_document_id.val();
