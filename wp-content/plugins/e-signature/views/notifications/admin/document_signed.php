...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
  ...
  <td align="center" width="200" height="50" bgcolor="<?php echo $data['background_color']; ?>" style="color: #ffffff; display: block;"><a href="<?php echo $data['view_url']; ?>" style="font-size:14px; font-family:sans-serif; text-decoration: none; line-height:50px; width:100%; display:inline-block"><span style="color: #ffffff;"><?php _e('View Signed Document','esig'); ?></span></a></td> 
  </tr> </table> 
  <![endif]>
