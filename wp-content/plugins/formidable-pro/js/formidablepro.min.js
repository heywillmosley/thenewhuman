...
b&&Xa(a)):!1!==v(a.containerId,a.formId)&&(y(a.containerId,a.formId),b?(b=ia(a.containerId),ja(b,"divider"==a.fieldType||"form"==a.fieldType,a.formId),jQuery("#"+a.containerId).show()):(b=ka(a),ja(b,"divider"==a.fieldType||"form"==a.fieldType,a.formId))):L(a,b)}function K(a){return"undefined"===typeof __FRMRULES||"undefined"===typeof __FRMRULES[a]?!1:__FRMRULES[a]}function Ua(a,b){var c=K(a.fieldId),d=la(c,b);"data"==b.fieldType&&"data"==c.fieldType?(c=""===a.value?""===d||1==d.length&&""===d[0]?
!1:!0:M(a.operator,a.value,d),b.dataLogic=a,b.dataLogic.actualValue=d,d=c):d=M(a.operator,a.value,d);return d}function la(a,b){if("radio"==a.inputType||"checkbox"==a.inputType||"toggle"==a.inputType){var c=ma(a,b);c=document.querySelectorAll('input[name^="'+c+'"]');c="checkbox"===a.inputType||"toggle"===a.inputType?C(c):N(c)}else if(!0===a.isMultiSelect){c=ma(a,b);var d=document.querySelectorAll('[name^="'+c+'"]');1==d.length&&"hidden"!=d[0].type?(c=jQuery('[name^="'+c+'"]').val(),null===c&&(c="")):
...
b},LIKE:function(a,b){if(!b)return!1;a=O(a);b=na(a,b);return-1!=b.indexOf(a)},"not LIKE":function(a,b){if(!b)return!0;a=O(a);b=na(a,b);return-1==b.indexOf(a)}}[a](b,c)}function Ya(a){-1!==String(a).search(/^\s*(\+|-)?((\d+(\.\d+)?)|(\.\d+))\s*$/)?a=parseFloat(a):"string"===typeof a&&(a=a.trim());return a}function Za(a,b){if("undefined"===typeof b||null===b||!1===b)b="";jQuery.isArray(b)&&-1<jQuery.inArray(String(a),b)&&(b=a);"number"===typeof a&&"string"===typeof b&&(b=parseFloat(b));"string"===typeof b&&
(b=b.trim());return b}function na(a,b){b=O(b);if(jQuery.isArray(b))for(var c=0,d=b.length;c<d;c++){var e=b[c].toLowerCase();if(-1<e.indexOf(a)){b=a;break}}return b}function O(a){"string"===typeof a?a=a.toLowerCase():"number"===typeof a&&(a=a.toString());return a}function ha(a){return"show"==a?"hide":"show"}function ia(a){return document.getElementById(a).querySelectorAll('select[name^="item_meta"], textarea[name^="item_meta"], input[name^="item_meta"]')}function ka(a){if("divider"==a.fieldType){var b=
[];"divider"==a.fieldType&&(b=document.querySelectorAll('[data-sectionid="'+a.fieldId+'"]'));a=b}else"form"==a.fieldType?a=document.querySelectorAll('[id^="field_'+a.fieldKey+'-"]'):(a=a.isRepeating?"item_meta["+B(a)+"]["+a.repeatRow+"]["+a.fieldId+"]":"item_meta["+a.fieldId+"]",a=document.querySelectorAll('[name^="'+a+'"]'));return a}function ja(a,b,c){if(a.length)for(var d,e=["checkbox","radio"],f=0;f<a.length;f++)if(!(0<f&&"undefined"!==typeof d&&d.name==a[f].name&&-1<e.indexOf(d.type)||b&&D(a[f],
...
null!==c&&b.push(c));c=0;for(d=b.length;c<d;c++){ea(a,b[c].id);var e=a,f=b[c];e.parentVals=ra(e);if("select"==e.inputType)$a(e,f);else if("radio"==e.inputType||"checkbox"==e.inputType)if(!1===e.parentVals){var h=f.getElementsByTagName("input");sa(e,f);F(h)}else ab(e,f)}}else if("value changed"===c)for(c="field_"+a.fieldKey,c=a.isRepeating?""!==b.repeatingSection?'[id="'+c+"-"+b.repeatRow+'"]':'[id^="'+c+'-"]':'[id="'+c+'"]',b=document.querySelectorAll(c),c=0,d=b.length;c<d;c++)e=a,f=w(b[c].name),
e.repeatRow=""!==f.repeatRow?f.repeatRow:"",pa(a,b[c])}function P(a){return"undefined"===typeof __FRMLOOKUP||"undefined"===typeof __FRMLOOKUP[a]?!1:__FRMLOOKUP[a]}function pa(a,b){a.parentVals=ra(a);var c=b.id;c in n&&0<n[c].length?ta(a,b):(ta(a,b),ua(a,b))}function ra(a){for(var b=[],c=a.parents,d,e=0,f=c.length;e<f;e++){d=P(c[e]);d=la(d,a);if(""===d||!1===d){b=!1;break}b[e]=d}return b}function N(a){for(var b=!1,c=a.length,d=0;d<c;d++)if("hidden"==a[d].type||a[d].checked){b=a[d].value;break}return b}
...
url:frm_js.ajax_url,data:{action:"frm_fields_ajax_get_data",entry_id:a.dataLogic.actualValue,current_field:a.fieldId,hide_id:a.containerId,on_current_page:b,nonce:frm_js.nonce},success:function(d){if(b){var e=c.find(".frm_opt_container, .frm_data_container");e.html(d);var f=e.children("input"),h=f.val();za(e);""===d||""===h?L(a,!0):Aa(a,c,f,!0)}else e="field_"+a.fieldKey,""!==a.repeatRow&&(e+="-"+a.repeatRow),e=document.getElementById(e),e.value=d,v(a.containerId,a.formId)&&y(a.containerId,a.formId),
r(jQuery(e))}})}function Xa(a,b){var c=jQuery("#"+a.containerId),d=c.find('select[name^="item_meta"], input[name^="item_meta"]'),e=Ba(d);d=d.data("frmval");var f=c.closest("form").find('input[name="id"]').val();ya(c);jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_data_options",trigger_field_id:a.dataLogic.fieldId,entry_id:a.dataLogic.actualValue,field_id:a.fieldId,default_value:d,container_id:a.containerId,editing_entry:f,prev_val:e,nonce:frm_js.nonce},success:function(b){var d=
c.find(".frm_opt_container, .frm_data_container");d.html(b);var f=d.find('select, input[type="checkbox"], input[type="radio"]');za(d);""===b||1>f.length?L(a,!0):(b=Ba(f),Aa(a,c,f,e!==b))}})}function ya(a){var b=a.html();-1<b.indexOf("frm-loading-img")||(a.html(b+'<span class="frm-loading-img"></span>'),a.find(".frm_opt_container, .frm_data_container").hide())}function cb(a,b){if(!(-1<a.innerHTML.indexOf("frm-loading-img"))){b.style.display="none";var c=document.createElement("span");c.setAttribute("class",
...
w(a.triggerField.attr("name"));var d=a.thisFieldCall.replace("[id=","[id^=").replace(/-"]/g,"-"+c.repeatRow+'"]');if(b.length||""!==c.repeatRow){if(c=b.length?b.find(d):jQuery(d),null===c||"undefined"===typeof c||1>c.length)c=null,d.indexOf(":checked")?1>b.find(d.replace(":checked","")).length&&(c=jQuery(a.thisFieldCall)):c=jQuery(a.thisFieldCall)}else c=jQuery(a.thisFieldCall);return c}function Ha(a,b){var c=!1;if("hidden"==b.type)""!==W(b)&&(c=!0);else if("select"==a.type){var d=b.className;d&&
...
function W(a){var b="";a=document.getElementById(a.id+"-otext");null!==a&&""!==a.value&&(b=a.value);return b}function jb(a,b){X("pageLoad");var c=jQuery(b).find('input[name="id"]');c.length&&(c=document.getElementById("frm_edit_"+c.val()),null!==c&&-1<c.className.indexOf("frm_cancel_edit")&&Ia(jQuery(c)));H()}function kb(){H()}function lb(a,b){google.load("visualization","1.0",{packages:[b],callback:function(){var b=new google.visualization.DataTable,d=!1;-1!==jQuery.inArray("id",a.options.fields)&&
(d=!0,b.addColumn("number",frm_js.id));for(var e=a.fields.length,f,h=0,g=e;h<g;h++){var k=a.fields[h];f=Ja(k);b.addColumn(f,k.name)}h=!1;a.options.edit_link&&(h=!0,b.addColumn("string",a.options.edit_link));g=!1;a.options.delete_link&&(g=!0,b.addColumn("string",a.options.delete_link));if(null!==a.entries){var l=a.entries.length;b.addRows(l);for(var m=0,p=0;p<l;p++){k=0;var q=a.entries[p];d&&(b.setCell(m,k,q.id),k++);for(var n=0,r=e;n<r;n++){var t=a.fields[n];f=Ja(t);t=q.metas[t.id];"number"!=f||null!==
...
a.options);jQuery(document).trigger("frmDrawChart",[c,"chart_"+a.graph_id,b])}}})}function Ja(a){var b="string";if("number"==a.type)b="number";else if("checkbox"==a.type||"select"==a.type){var c=a.options.length;"select"==a.type&&""===a.options[0]&&(c="post_status"==a.field_options.post_field?3:c-1);1==c&&(b="boolean")}return b}function nb(){var a=jQuery(this).data("key"),b=jQuery(this).data("parent"),c="frm_section_"+b+"-"+a,d=jQuery(document.getElementById(c)),e=d.find("input, select, textarea"),
...
(c=" star-rating-on"),""!==c&&(b[d].className+=c))}function Ka(){jQuery(document).on("input","input[data-frmrange]",function(){var a=jQuery(this);a.next(".frm_range_value").html(a.val())})}function wb(){var a,b=jQuery(".frm_inline_form .frm_fields_container");if(b.length)for(a=0;a<b.length;a++){var c=jQuery(b[a]);var d=c.children(".frm_form_field");if(12>=d.length&&!Ma(d.last())){var e=d;var f=Math.max(2,Math.ceil(12/(e.length+1)));for(d=0;d<e.length;d++)Ma(jQuery(e[d]))||jQuery(e[d]).addClass("frm"+
...
typeof b&&(b="dependent");1<a.length&&(a=a.eq(0));a.trigger({type:"change",selfTriggered:!0,frmTriggered:b})}function w(a){var b={repeatingSection:"",repeatRow:""};"undefined"!==typeof a&&A(a)&&(a=a.split("]["),b.repeatingSection=a[0].replace("item_meta[",""),b.repeatRow=a[1]);return b}function Sa(a){a.fadeOut("slow",function(){a.remove()})}function eb(a,b){for(var c in a)if(a.hasOwnProperty(c)&&a[c]===b)return c;return null}function Fa(a){return!jQuery.isArray(a)&&0<=a-parseFloat(a)+1}var I=!1,Va=
"",u=0,n={};return{init:function(){jQuery(document).on("frmFormComplete",jb);jQuery(document).on("frmPageChanged",kb);jQuery(document).on("click",".frm_trigger",Oa);var a=jQuery(".frm_blank_field");a.length&&a.closest(".frm_toggle_container").prev(".frm_trigger").click();jQuery(document).on("click",".frm_remove_link",Ra);jQuery(document).on("focusin","input[data-frmmask]",function(){jQuery(this).mask(jQuery(this).data("frmmask").toString(),{autoclear:!1})});jQuery(document).on("frmFieldChanged",ba);
jQuery(document).on("mouseenter click",".frm-star-group input",tb);jQuery(document).on("mouseenter",".frm-star-group .star-rating:not(.star-rating-readonly)",ub);jQuery(document).on("mouseleave",".frm-star-group .star-rating:not(.star-rating-readonly)",vb);jQuery(document).on("click",'.frm-show-form input[type="submit"], .frm-show-form input[name="frm_prev_page"], .frm_page_back, .frm_page_skip, .frm-show-form .frm_save_draft, .frm_prev_page, .frm_button_submit',Y);jQuery(document).on("change",'.frm_other_container input[type="checkbox"], .frm_other_container input[type="radio"], .frm_other_container select',
Ta);jQuery(document).on("click",".frm_remove_form_row",nb);jQuery(document).on("click",".frm_add_form_row",ob);jQuery(".frm_edit_link_container").on("click","a.frm_inplace_edit",pb);jQuery(".frm_edit_link_container").on("click","a.frm_cancel_edit",qb);jQuery(document).on("click",".frm_ajax_delete",rb);jQuery(".frm_month_heading, .frm_year_heading").click(function(){var a=jQuery(this).children(".ui-icon-triangle-1-e, .ui-icon-triangle-1-s");a.hasClass("ui-icon-triangle-1-e")?(a.addClass("ui-icon-triangle-1-s").removeClass("ui-icon-triangle-1-e"),
jQuery(this).next(".frm_toggle_container").fadeIn("slow")):(a.addClass("ui-icon-triangle-1-e").removeClass("ui-icon-triangle-1-s"),jQuery(this).next(".frm_toggle_container").hide())});wb();X("pageLoad");H()},savingDraft:function(a){var b=!1;a=jQuery(a).find(".frm_saving_draft");a.length&&(b=a.val());return b},goingToPreviousPage:function(a){var b=!1,c=jQuery(a).find(".frm_next_page");if(c.length&&c.val()){var d=jQuery(a).find('input[name="form_id"]').val();a=jQuery(a).find('input[name="frm_page_order_'+
