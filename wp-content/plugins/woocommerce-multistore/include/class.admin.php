            ...
            function network_admin_menu()
                {
                    ...
                    $menus_hooks[] =    add_submenu_page( 'woonet-woocommerce', __( 'Upgrade', 'woocommerce' ), __( 'Upgrade', 'woocommerce' ), 'manage_product_terms', 'woonet-upgrade', array($data_update, 'update_run') ); 
