                ...
                foreach($network_sites as $network_site)
                    {
                        ...
                        ?>
                            <label class="alignleft">
                                    ...
                                    <input type="checkbox" value="yes" data-blog-id="<?php echo $network_site->blog_id ?>" data-default-value="" name="_woonet_publish_to_<?php echo $network_site->blog_id ?>" class="_woonet_publish_to" />
                                    <span class="checkbox-title"><?php echo $blog_details->blogname ?> <span class="warning"><?php _e('<b>Warning:</b> By unselecting this shop the product is unasigned, but not deleted from the shop, witch should be done manually.', 'woonet') ?></span></span>
