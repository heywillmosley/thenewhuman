...
<div id="export-orders-filters-voucher_redeemed" class="separator">
	<ul>
		<li>
			<label><input type="radio" name="order_voucher_redeemed_filter" value=""<?php checked( $types, false ); ?> /> <?php _e( 'All Orders', 'woocommerce-exporter' ); ?></label>
		</li>
		<li>
			<label><input type="radio" name="order_voucher_redeemed_filter" value="redeemed"<?php checked( $types, 'redeemed' ); ?> /> <?php _e( 'Orders marked as redeemed', 'woocommerce-exporter' ); ?></label>
		</li>
		<li>
			<label><input type="radio" name="order_voucher_redeemed_filter" value="unredeemed"<?php checked( $types, 'unredeemed' ); ?> /> <?php _e( 'Orders marked un-redeemed', 'woocommerce-exporter' ); ?></label>
		</li>
	</ul>
</div>
...
<div id="export-orders-filters-order_type" class="separator">
	<ul>
		<li>
			<label><input type="radio" name="order_order_type_filter" value=""<?php checked( $types, false ); ?> /> <?php _e( 'All Orders', 'woocommerce-exporter' ); ?></label>
		</li>
		<li>
			<label><input type="radio" name="order_order_type_filter" value="original"<?php checked( $types, 'original' ); ?> /> <?php _e( 'Original', 'woocommerce-exporter' ); ?></label>
		</li>
		<li>
			<label><input type="radio" name="order_order_type_filter" value="parent"<?php checked( $types, 'parent' ); ?> /> <?php _e( 'Subscription Parent', 'woocommerce-exporter' ); ?></label>
		</li>
		<li>
			<label><input type="radio" name="order_order_type_filter" value="renewal"<?php checked( $types, 'renewal' ); ?> /> <?php _e( 'Subscription Renewal', 'woocommerce-exporter' ); ?></label>
		</li>
		<li>
			<label><input type="radio" name="order_order_type_filter" value="resubscribe"<?php checked( $types, 'resubscribe' ); ?> /> <?php _e( 'Subscription Resubscribe', 'woocommerce-exporter' ); ?></label>
		</li>
		<li>
			<label><input type="radio" name="order_order_type_filter" value="switch"<?php checked( $types, 'switch' ); ?> /> <?php _e( 'Subscription Switch', 'woocommerce-exporter' ); ?></label>
		</li>
		<li>
			<label><input type="radio" name="order_order_type_filter" value="regular"<?php checked( $types, 'regular' ); ?> /> <?php _e( 'Non-subscription', 'woocommerce-exporter' ); ?></label>
		</li>
	</ul>
</div>
...
function woo_ce_extend_order_fields( $fields = array() ) {
	...
	if( woo_ce_detect_wpml() && woo_ce_detect_export_plugin( 'wpml_wc' ) ) {
		$fields[] = array(
			'name' => 'order_language',
			'label' => __( 'Order Language', 'woocommerce-exporter' ),
...
function woo_ce_order_extend( $order, $order_id ) {
	...
	// WooCommerce Multilingual - https://wordpress.org/plugins/woocommerce-multilingual/
	if( woo_ce_detect_wpml() && woo_ce_detect_export_plugin( 'wpml_wc' ) ) {
		$order->order_language = get_post_meta( $order_id, 'wpml_language', true );
	}
...
function woo_ce_extend_order_dataset_args( $args, $export_type = '' ) {
	...
	$defaults = array(
		...
		// WooCommerce PDF Product Vouchers - http://www.woothemes.com/products/pdf-product-vouchers/
		'order_voucher_redeemed' => ( isset( $_POST['order_voucher_redeemed_filter'] ) ? sanitize_text_field( $_POST['order_voucher_redeemed_filter'] ) : false ),
		// WooCommerce Subscriptions - http://www.woothemes.com/products/woocommerce-subscriptions/
		'order_order_type' => ( isset( $_POST['order_order_type_filter'] ) ? sanitize_text_field( $_POST['order_order_type_filter'] ) : false )
	);
