        ...
        public function esig_verify_access_code() {
            ...
            if (self::is_access_code_used($document_id, $email_address)) {
                ...
                if ($old_password == $access_code) {
                    ...
                    _e("<span class='icon-esig-alert'></span><span class='error-email-password'>The Password or email that you entered is incorrect. Please try again or contact the document administrator.</span>", "esig");
