        ...
        <h2><span id="heading"> <?php _e('Security Verification', 'esig') ?></span><h2>
                ...
                <div class="tab" >
                    ...
                    <div id="none" class="tab-content">
                        <br><div class="slv-instructions">Hey <?php echo sprintf(__(' %s! You\'re gonna need to select your desired security verification to go to next step.', 'esig'), WP_E_Sig()->user->getUserFullName(WP_E_Sig()->user->getCurrentUserID())); ?></div>
                    ...
                    <div id="access_code" class="tab-content" style="display: none">
                        ...
                        <div class="slv-access-inputs"><label class="slv-label"><?php _e('Access Code:', 'esig'); ?></label><br>
                            <input type="text" name="esig_access_code" id="esig_access_code" class="enter_access" placeholder="Enter your access code"></div><span>
