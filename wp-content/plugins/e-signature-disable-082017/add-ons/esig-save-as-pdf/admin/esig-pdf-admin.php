	...
	";
                ...
                if (!empty($allinvitaions)) {
                    ...
                    foreach ($allinvitaions as $invite) {
						...
						<span class="esig-signature-type-font" style="font-family:' . $font . ';font-size:' . $font_size . '!important;" width="400" height="100px">' . $sign_data . '</span></div>';
                            ...
                            $this->esign_set_json($invite->user_id, $document->document_checksum);

                            $sign = '<img src="' . plugins_url() . '/esig-save-as-pdf/includes/sigtoimage.php?uid=' . $invite->user_id . '&doc_id=' . $document->document_checksum . '" width="255px" height="100px">';
                        }
                ...
                if ($document->add_signature) {
                    ...
                    if ($signature_type == "typed") {
                        ...
                        $this->esign_set_json($owner->user_id, $document->document_checksum, true);
                        $sign_admin = '<img src="' . plugins_url() . '/esig-save-as-pdf/includes/sigtoimage.php?uid=' . $owner->user_id . '&doc_id=' . $document->document_checksum . '&owner_id=1" width="255px" height="100px">';
                    } else {
		...
		<div {$font_family} class='footer-right'>
