...
<body>
<p>'._e('<span style="color:red; font-weight: bold;">WARNING</span>: This utility will OVERWRITE mpdf.php file in the current directory.','esig-pdf').'</p>
<p>'._e('Select the functions you wish to INCLUDE in your mpdf.php program. When you click generate, a new mpdf.php file will be written to the current directory.','esig-pdf').'</p>
<div><b>Notes</b>
<ul>
<li>'._e('HTML-CSS is required for many of the other functions to work including: Tables, Lists, Backgrounds, Forms, Border-radius and all other CSS','esig-pdf').'</li>
<li>'._e('DIRECTW includes the functions to Write directly to the PDF file e.g. Write, WriteText, WriteCell, Text, Shaded_box, AutosizeText','esig-pdf').'</li>
<li>'._e('You must include either HTML-CSS or DIRECTW','esig-pdf').'</li>
<li>'._e('JPG, PNG and JPG images are supported with IMAGES-CORE','esig-pdf').'</li>
<li>'._e('For WMF Images, you must include both IMAGES-CORE and IMAGES-WMF','esig-pdf').'</li>
<li>'._e('IMAGES-CORE are required for BACKGROUNDS (IMAGES) or WATERMARKS to work','esig-pdf').'</li>
</ul>
</div>
<input type="checkbox" name="checkall" onclick="checkedAll(frm1);"> <i>'._e('Select/Unselect All','esig-pdf').'</i><br /><br />
...
echo '<p><b>'._e('mPDF file generated successfully!','esig-pdf').'</b></p>';
