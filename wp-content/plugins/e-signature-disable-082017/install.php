...
$sql = "CREATE TABLE IF NOT EXISTS `" . $table_prefix . "documents_events`(
			  ...
			  `date` datetime NOT NULL) ENGINE = INNODB DEFAULT CHARSET=utf8 DEFAULT COLLATE utf8_unicode_ci";
dbDelta($sql);
...
$sql = "CREATE TABLE IF NOT EXISTS `" . $table_prefix . "users`(
			  ...
			  `last_name` varchar(65) NOT NULL) ENGINE = INNODB DEFAULT CHARSET=utf8 DEFAULT COLLATE utf8_unicode_ci";
dbDelta($sql);
