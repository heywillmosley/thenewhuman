...
<?php if (WP_E_General::is_auto_save_enabled()): ?>
            ...
            <span class="esig-right" style="display:none;" id="esig-preview-document">
                <a href="<?php echo site_url(); ?>?page_id=<?php echo WP_E_Sig()->setting->get_default_page(); ?>&esigpreview=1&document_id=<?php echo $document_id; ?>&mode=1" target="_blank" class="submit button esig-preview button-large"><?php _e(' Preview Document', 'esign'); ?> </a>
            </span>
