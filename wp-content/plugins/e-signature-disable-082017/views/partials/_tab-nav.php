    ...
    <div id='esig-headlink-col1'>
        ...
        <div class="esig-masthead">
            <a href='http://www.approveme.me/wp-digital-e-signature' target='_blank' style='text-decoration:none;'>
                <img src='<?= ESIGN_ASSETS_DIR_URI ; ?>/images/logo.png' alt='WP E-Signature'>
            </a>
            <br>
            <img src='<?= ESIGN_ASSETS_DIR_URI; ?>/images/pen_icon_gray.svg' alt='Signing documents just got easier'>
