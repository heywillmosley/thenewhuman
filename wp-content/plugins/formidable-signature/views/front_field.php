...
?> style="max-width:<?php echo esc_attr( (int) $styles['width'] ); ?>px;">
	<div class="sig sigWrapper" style="<?php echo esc_attr( $styles['css'] ); ?>">
		...
		<ul class="sigNav">
			<li class="drawIt"><a href="#" class="current" title="<?php echo esc_html( $field['label1'] ); ?>" aria-label="<?php echo esc_html( $field['label1'] ); ?>"><i class="fas fa-pencil-alt" aria-hidden></i></a></li>
			<li class="typeIt"><a href="#" title="<?php echo esc_html( $field['label2'] ); ?>" aria-label="<?php echo esc_html( $field['label2'] ); ?>"><i class="far fa-keyboard" aria-hidden></i></a></li>
		</ul>
		<?php } ?>
		<div class="typed">
