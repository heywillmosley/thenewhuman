...
<?php if ( $order->has_status( 'pending' ) ) : ?>
    ...
    <p><?php printf( __( 'Hi, <br>Your Invoice for Balance Payment of %s from payment #%s has been generated . The Payment details are as follows' , _sumo_pp()->text_domain ) , $product_title , _sumo_pp_get_payment_number( $payment_id ) ) ; ?></p>
