...
function detailViewFields(){
	...
	if(jQuery("#detail_view").is(':checked')){		
		...
		//jQuery(".variation_dropdowns").attr('disabled',false);
		...
		jQuery(".variation_dropdowns").attr('disabled',true);
	}
		...
		if(l > 0){
			...
			jQuery("#variations option:selected" ).each(function() {
				...
				if(variation_dropdowns == "-1"){
					...
					jQuery("#variation_dropdown_"+variation_dropdowns).attr('disabled',false).removeClass('disabled');
				}
			});	
		}else{
