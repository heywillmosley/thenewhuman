...
if ( ! class_exists( 'IC_Commerce_Golden_All_Report' ) ) {
	//require_once('ic_commerce_golden_functions.php');
	class IC_Commerce_Golden_All_Report extends IC_Commerce_Golden_Functions{
		...
		*/
		...
		function _____ic_commerce_report_page_data_items($order_items = '', $request = '', $type = '', $page = '', $report_name = ''){
