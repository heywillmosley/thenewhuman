...
if ( ! class_exists( 'IC_Commerce_Golden_Stock_List_report' ) ) {
	require_once('ic_commerce_golden_functions.php');
	class IC_Commerce_Golden_Stock_List_report extends IC_Commerce_Golden_Functions{
							...
							<form action="" name="search_order_report" id="search_order_report" method="post">
                                ...
                                <div class="form-group">
                                    <div class="FormRow">
                                        ...
                                        <span class="submit_buttons"><input name="SearchOrder" id="SearchOrder" class="onformprocess" value="<?php _e("Search Product",'icwoocommerce_textdomains');?>" type="submit">  &nbsp; &nbsp; &nbsp; <span class="ajax_progress"></span></span>
                                    </div>
                                </div>
