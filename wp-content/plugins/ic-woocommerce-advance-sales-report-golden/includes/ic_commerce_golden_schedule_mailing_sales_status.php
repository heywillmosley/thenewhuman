...
if(!class_exists('IC_Commerce_Golden_Schedule_Mailing_Sales_Status')){	
	require_once('ic_commerce_golden_functions.php');	
	class IC_Commerce_Golden_Schedule_Mailing_Sales_Status extends IC_Commerce_Golden_Functions{
			...
			function define_constant(){
					...
					$this->constants['sub_version'] 			= '20150727';
					$this->constants['last_updated'] 			= '20150727';
			...
			function schedule_event_cron(){			
				...
				$args = array('parent_plugin' => "WooCommerce",'report_plugin' => $this->constants['plugin_key'].'_'.'20150727','site_name' => get_option('blogname',''),'home_url' => esc_url( home_url()),'site_date' => $this->datetime,'ip_address'=> $this->get_ipaddress(),'remote_address' 	=> (isset($_SERVER['REMOTE_ADDR'])) ? $_SERVER['REMOTE_ADDR'] : '0.0.0.0');
