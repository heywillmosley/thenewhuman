...
if ( ! class_exists( 'IC_Commerce_Golden_Custom_fields' ) ) {
	class IC_Commerce_Golden_Custom_fields{
		...
		function woocommerce_order_ic_commerce_fields_add($order_id = 0){
				$columns = array(					
					// "ic_commerce_order_billing_name"			=>	__("Name", 				'icwoocommerce_textdomains')
					//"ic_commerce_order_status_name"			=>	__("Status", 			'icwoocommerce_textdomains')
					...
					,"ic_commerce_order_item_count"				=>	__("Items", 			'icwoocommerce_textdomains')
					//,"ic_commerce_order_billing_sate"			=> __("Billing State", 		'icwoocommerce_textdomains')
					//,"ic_commerce_order_shipping_sate"		=> __("Shipping State", 	'icwoocommerce_textdomains')
					//,"ic_commerce_order_billing_country"		=> __("billing_country", 	'icwoocommerce_textdomains')
					//,"ic_commerce_order_shipping_country"		=> __("shipping_country", 	'icwoocommerce_textdomains')
					//,"ic_commerce_order_shipping_method"		=> __("shipping_method", 	'icwoocommerce_textdomains')
				);
