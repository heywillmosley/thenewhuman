...
if ( ! class_exists( 'IC_Commerce_Golden_Variation_Stock_List_report' ) ) {
	//require_once('ic_commerce_golden_functions.php');
	class IC_Commerce_Golden_Variation_Stock_List_report extends IC_Commerce_Golden_Functions{
                               ...
                               <?php } ?>   
                                ...
                                <div class="form-group">
                                    <div class="FormRow">
                                        ...
                                        <input name="SearchOrder" id="SearchOrder" class="onformprocess" value="Search Product" type="submit">  &nbsp; &nbsp; &nbsp; <span class="ajax_progress"></span></span>
