...
if ( ! class_exists( 'IC_Commerce_Golden_Detail_report' ) ) {
	//require_once('ic_commerce_golden_functions.php');global $back_day;$back_day = "0";
	class IC_Commerce_Golden_Detail_report extends IC_Commerce_Golden_Functions{
                                    ...
                                    <form action="" name="Report" id="search_order_report" method="post">
                                        <div class="form-table">
											...
											<div class="form-group">          
												...
												<div class="FormRow">
													<div class="label-text"><label for="product_sku">Variation SKU:</label></div>
													<div class="input-text">						
														<?php 
                                            ...
                                            <div class="form-group">
                                                <div class="FormRow" style="width:100%">
                                                    ...
                                                    <input type="hidden" name="variation_only" 			id="variation_only_2"   value="<?php echo $this->get_request('variation_only','-1',true);?>" />
                                                    ...
                                                    <input type="hidden" name="order_item_id" 			id="order_item_id" 		value="<?php echo $this->get_request('order_item_id','-1',true);?>" />
                                                    <input type="hidden" name="order_date_field_key" 	id="order_date_field_key" value="<?php echo $this->get_request('order_date_field_key',$order_date_field_key,true);?>" />
		...
		function ic_commerce_custom_report_normal_query($type = 'total_row', $columns = array(), $total_columns = array()){
					...
					//}else{
						...
						if(($first_name and $first_name != '-1')){
							$columns_sql .= " postmeta3.meta_value AS first_name," ;
						}
						if(($last_name and $last_name != '-1')){
							$columns_sql .= " postmeta4.meta_value AS last_name," ;
						}
						...
						$columns_sql .= " 	  
							...
							DATE_FORMAT(posts.{$order_date_field_key},'%m/%d/%Y') AS order_date
					...
					if(!$this->normal_sql_query){
						...
						if(($last_name and $last_name != '-1')){
							$sql .= " AND postmeta4.meta_key='_billing_last_name' ";
						}
						...
						if($first_name)	$sql .= " AND postmeta3.meta_value LIKE '%".$first_name."%'";
						
						if($last_name)	$sql .= " AND postmeta4.meta_value LIKE '%".$last_name."%'";						
