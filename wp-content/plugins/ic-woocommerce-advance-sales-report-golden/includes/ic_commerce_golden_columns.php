...
if ( ! class_exists( 'IC_Commerce_Golden_Columns' ) ) {
	class IC_Commerce_Golden_Columns{
			...
			if($report_name == "recent_order"){
				if($this->constants['post_order_status_found'] == 0 ){
					$columns 	= array(
						...
						//,"order_discount"							=> 	__("Discount Amt.", 	'icwoocommerce_textdomains')
						...
						,"order_tax"								=> 	__("Item Tax Amt.", 	'icwoocommerce_textdomains')
		...
		function result_columns_details_page($detail_column = 'no'){
			...
			if($detail_column == "yes"){
				$columns = array(
					...
					,"total_row_count"								=> 	__("Product Count", 	'icwoocommerce_textdomains')
					//,"total_discount"							=> __("Ord. Discount Amt.", 		'icwoocommerce_textdomains')
		...
		function grid_columns_all_reports($report_name = 'product_page'){
			...
			switch ($report_name ) {
				...
				case "order_status":
					...
					break;
				case "recent_order":
					$status_key = "order_status_name";////New Change ID 20140918
				...
				case "coupon_page":
					$columns 	= array(
						...
						//,"coupon_amount"							=> __("Coupon Amount", 		'icwoocommerce_textdomains')
						,"total_amount"								=> __("Coupon Amount", 		'icwoocommerce_textdomains')
						);		
					break;
				case "coupon_couontry_page":
					$columns 	= array(
						"coupon_code"								=> __("Coupon Code", 		'icwoocommerce_textdomains')
						,"billing_country"							=> __("Country Name", 		'icwoocommerce_textdomains')
						,"coupon_count"								=> __("Coupon Count", 		'icwoocommerce_textdomains')
						//,"coupon_amount"							=> __("Coupon Amount", 		'icwoocommerce_textdomains')						
						,"total_amount"								=> __("Coupon Amount", 		'icwoocommerce_textdomains')
						);		
				...
				case "advance_product_page"://New Custom Change ID 20141009
					...
					break;		
				case "cost_of_good_page"://New Custom Change ID 20141013
					$columns 	= array(
						"product_sku"								=> __("Product SKU", 		'icwoocommerce_textdomains')
						,"product_name"								=> __("Product Name", 		'icwoocommerce_textdomains')
						,"quantity"									=> __("Sales Quantity", 	'icwoocommerce_textdomains')
						,"cost_of_good_amount"						=> __("Unit Cost", 			'icwoocommerce_textdomains')
						,"total_cost_good_amount"					=> __("Cost of Goods", 		'icwoocommerce_textdomains')
						,"sales_rate_amount"						=> __("Sales Rate", 		'icwoocommerce_textdomains')
				...
				case "billing_state_page":
					...
					break;
				case "category_page"://New Change ID 20141208
					$columns 	= array(
				...
				case "manual_refund_detail_page":				
					$status_key = "ic_commerce_order_status_name";
					if($this->constants['post_order_status_found'] == 1 ){
						$status_key = "order_status";
					}else if($this->constants['post_order_status_found'] == 0 ){
						$status_key = "order_status_name";
		...
		function result_columns_all_reports($report_name = ''){
			$total_columns = array();
			switch($report_name){
				...
				case "cost_of_good_page"://New Custom Change ID 20141015
					$total_columns = array(
						"total_row_count"						=> __("Product Count", 			'icwoocommerce_textdomains')
						,"quantity"								=> __("Sales Quantity", 		'icwoocommerce_textdomains')
						,"cost_of_good_amount"					=> __("Unit Cost", 				'icwoocommerce_textdomains')
				...
				case "recent_order"://New Custom Change ID 20141015
					$total_columns = array(
						...
						,"order_shipping_tax"					=>  __("Shipping Tax Amt.", 	'icwoocommerce_textdomains')
						,"order_tax"							=>  __("Item Tax Amt.", 		'icwoocommerce_textdomains')
						//,"refund_amount"						=> 	__("Refund Amt.", 	        'icwoocommerce_textdomains')
						,"part_order_refund_amount"				=>  __("Part Refund Amt.",		'icwoocommerce_textdomains')
						,"order_total"							=>  __("Net Amt.", 				'icwoocommerce_textdomains')
				...
				case "coupon_page"://New Custom Change ID 20141015
					...
					break;
				case "coupon_couontry_page"://New Custom Change ID 20150427
					$total_columns = array(
						"total_row_count"						=> __("Result Count", 			'icwoocommerce_textdomains')
						,"coupon_count"							=> __("Coupon Count", 			'icwoocommerce_textdomains')
						//,"coupon_amount"						=> __("Coupon Amount", 			'icwoocommerce_textdomains')						
				...
				case "billing_state_page"://New Custom Change ID 20141015
					$total_columns = array(
	...
	}//END class IC_Commerce_Golden_Columns{
}//END if ( ! class_exists( 'IC_Commerce_Golden_Columns' ) ) {